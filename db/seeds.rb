...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  reviews_csv.each do |row|
    Review.create(product_id: row[2], created_at: row[3], updated_at: row[4], user_id: row[5], occupation: row[6], length: row[7], often: row[8], hourly_wage: row[9], rate_flexibility: row[10], rate_wage: row[11],

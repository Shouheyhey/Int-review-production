...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  reviews_csv.shift
  reviews_csv.foreach(encoding:"Shift_JIS:UTF-8") do |row|
    ...
    review_skills: row[20], review_environment: row[21], review_expectation: row[22],review_merit: row[23], review_training: row[24])
  end

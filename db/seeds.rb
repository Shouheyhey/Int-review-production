...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  reviews_csv.each do |row|
    Review.create(review: row[1], rate:[2], product_id: row[3], created_at: row[4], updated_at: row[5], user_id: row[6], occupation: row[7], length: row[8], often: row[9], hourly_wage: row[10], rate_flexibility: row[11],
